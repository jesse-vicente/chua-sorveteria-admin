<div class="table-responsive">
    <table class="table table-hover table-striped shadow-xs rounded" id="table-conta">
        ...
        @forelse ($contas as $conta)
            <tr>
                <td class="text-right">{{ ($conta->getCompra()) ? $conta->getCompra()->getNumeroNota() : $conta->getNumeroNota() }}</td>
                <td class="text-center">{{ $conta->getParcela() }}</td>
                @if ($conta->getCompra())
                    <td class="text-center">{{ date('d/m/Y', strtotime($conta->getCompra()->getDataEmissao())) }}</td>
                @else
                    <td class="text-center">{{ date('d/m/Y', strtotime($conta->getDataEmissao())) }}</td>
                @endif
                ...
                <td class="text-center">{{ ($conta->getCompra()) ? $conta->getCompra()->getDataCancelamento() : $conta->getDataCancelamento() }}</td>
